...
public class Database {
	...
	/*
	 * Sobald Klasse gestartet wird werden die Nutzerdaten ausgelesen Das
	 * gleiche passiert mit der Highscore
	 */
	...
	public boolean addUser(String username, String password, int levelDone) {
		for (User u : userdata) {
		...
		userdata.add(new User(username, pw, 0));
